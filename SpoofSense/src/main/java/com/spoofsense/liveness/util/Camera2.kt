...
internal class Camera2(private val activity: Activity, private val textureView: AutoFitTextureView) {
...
// We have nothing to do when the camera preview is working normally.
                ...
                STATE_WAITING_LOCK -> {
                    ...
                    if (afState == null || afState == CaptureResult.CONTROL_AE_STATE_INACTIVE) {
                        captureStillPicture()
